...
void example() {
	...
	std::cout << "------------- division de int -------------- " << std::endl;
	// à la place de l'argument context : j'ai juste mis null
	DivBloc div_instance_1 (context, &vbloc_1, &vbloc_2);
	std::cout << "Resulat de " << opi_1 << " - " << opi_2 << " = " << *div_instance_1.execute().int_type << std::endl;

	std::cout << "------------- division de double -------------- " << std::endl;
	...
	DivBloc div_instance_2 (context, &vbloc_1, &vbloc_2);
	std::cout << "Resulat de " << opd_1 << " - " << opd_2 << " = " << *div_instance_2.execute().double_type << std::endl;
